...
import { X, Users, Save, Image as ImageIcon, Type, AlignLeft } from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between px-12 py-8 border-b border-slate-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-500">Update group details</p>
            </div>
          </div>
          <motion.button 
        ...
        <form onSubmit={handleSubmit} className="p-12 space-y-10">
          <div className="flex flex-col items-center justify-center mb-4">
            ...
            >
              <div className="w-32 h-32 bg-slate-100 rounded-[40px] border-4 border-white shadow-xl flex items-center justify-center text-slate-400 overflow-hidden">
                {avatarUrl ? (
              ...
              <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-4 py-1.5 bg-white rounded-full shadow-lg border border-slate-100">
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Group Icon</span>
              </div>
            </motion.div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              <label className="block text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Icon URL</label>
              <div className="relative">
